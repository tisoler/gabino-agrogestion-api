...
export function buildCampaniaXls(campania: any): Buffer {
  ...
  const rows: (string | number | Date)[][] = [
    ...
    [],
    [
      "Produc. Neta Total (QQ)",
      num(campania.prodNetaTotalQq),
      "",
      "Sup. Cosechada",
      supCosechada,
    ],
    ...
    [
      "Rendimiento (qq/ha)",
      round2(resultados.rendimientoQqHa),
      "",
      "Precio ($/qq)",
      num(campania.precioXQq),
    ],
    [],
    [
      "DETALLE DE COSTOS",
      ...
      "",
      "Alquiler (QQ/ha)",
      num(campania.alquilerQqHa),
    ],
    [],
    [
      "Comercializaci\u00f3n (%)",
      num(campania.comercializacionPct),
      "",
      "Cosecha ($/ha)",
      num(campania.cosechaXHa),
    ],
    [],
    [
      "LABORES",
      "fecha",
      "superficie laboreada",
      "costo de labor/ha",
      "costo ponderado/ha",
    ],
    ["tipo", "", "", "", ""],
  ...
  rows.push([
    ...
    "",
    "",
    round2(resultados.costoTotalLaboresHa),
  ]);
  rows.push([]);
  ...
  rows.push([
    ...
    "",
    "",
    round2(resultados.costoTotalInsumosHa),
  ]);
  rows.push([]);
  ...
  rows.push([
    ...
    "",
    "",
    round2(resultados.costoTotalCostosHa),
    "",
  ]);
  rows.push([]);
  ...
  rows.push([
    "Ingreso neto",
    "",
    round2(resultados.ingresoNetoHa),
    round2(resultados.ingresoNetoLote),
    "",
  ]);
  rows.push([]);
  rows.push([
    "Costo cosecha",
    "",
    round2(resultados.costoCosechaHa),
    round2(resultados.costoCosechaLote),
    "",
  ]);
  rows.push([
    "Costo labores",
    "",
    round2(resultados.costoTotalLaboresHa),
    round2(resultados.costoTotalLaboresLote),
    "",
  ]);
  rows.push([
    "Costo insumos",
    "",
    round2(resultados.costoTotalInsumosHa),
    round2(resultados.costoTotalInsumosLote),
    "",
  ]);
  rows.push([
    "Costos varios",
    "",
    round2(resultados.costoTotalCostosHa),
    round2(resultados.costoTotalCostosLote),
    "",
  ]);
  rows.push([
    "Total de costos directos",
    "",
    round2(resultados.totalCostosDirectosHa),
    round2(resultados.totalCostosDirectosLote),
    "",
  ]);
  rows.push([]);
  rows.push([
    "Margen bruto S/ alquiler",
    "",
    round2(resultados.margenBrutoSAlquilerHa),
    round2(resultados.margenBrutoSAlquilerLote),
    "",
  ]);
  rows.push([
    "Costo de alquiler",
    "",
    round2(resultados.costoAlquilerHa),
    round2(resultados.costoAlquilerLote),
    "",
  ]);
  rows.push([
    "Margen bruto C/ alquiler",
    "",
    round2(resultados.margenBrutoCAlquilerHa),
    round2(resultados.margenBrutoCAlquilerLote),
    "",
  ]);
